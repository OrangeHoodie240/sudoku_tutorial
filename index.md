...
<body>
    ...
    <div id='basics'>
        ...
        <figure>
            <img class='tutorial-small-img' alt='sudoku-diagram' src='/sudoku.png'>
            <figcaption>
    ...
    <div id='last-remaining-cell'>
        ...
        <figure>
            <img class='tutorial-small-img' alt='last-remaining-cell-diagram' src='/lastRemainingCell.png'>
            <figcaption>
    ...
    <div id='sole-candidate'>
        ...
        <figure>
            <img class="tutorial-small-img" alt='sole candidate diagram' src='/soleCandidate.png'>
            <figcaption>
    ...
    <div id='unique-candidate-box'>
        ...
        <figure>
            <img class='tutorial-small-img' alt='unique candidate diagram' src='/uniqueCandidate.png'>
            <figcaption>
    ...
    <div id='unique-candidate-row-or-col'>
        ...
        <figure>
            <img class='tutorial-small-img' alt='unique candidate diagram' src='/uniqueCandidateRowOrCol.png'>
            <figcaption>
    ...
    <div id='pointing-pairs-and-triples'>
        ...
        <figure>
            <img class='tutoral-large-img' alt='pointing-pairs-and-triples diagram' src='./pointingPairsAndTriples.png'>
            <figcaption>
    ...
    <div id='box-line-reduction'>
        ...
        <figure>
            <img class='tutoral-large-img' alt='box-line-reduction diagram' src='./boxLineReduction.png'>
            <figcaption>
    ...
    <div id='naked-subset'>
        ...
        <figure>
            <img class='tutoral-large-img' alt='naked subset diagram' src='./nakedSubset.png'>
            <figcaption>
    ...
    <div id='hidden-subset'>
        ...
        <figure>
            <img class='tutoral-large-img' alt='hidden subset diagram' src='./hiddenSubset.png'>
            <figcaption>
